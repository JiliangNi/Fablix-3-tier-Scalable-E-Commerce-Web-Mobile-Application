...
public class MoviePreviousButtonOnClickListener implements OnClickListener {

    String query;
    Integer page;

    public MoviePreviousButtonOnClickListener(String title,Integer pagen){
        this.query=title;
        this.page=pagen-1;
    ...
    public void connectToFabflix(final View view){
       ...
       String url ="http://52.53.176.245:8080/project22/AndroidMovieList?lim=5&pn="+page+"&pre_title="+query;
        //String url = "http://52.53.176.245:8080/project4/android/moviesearch?pageNumber=" + (movie.getCurrentPageNumber() - 1)  + "&title=" + movie.getTitleQuery();
